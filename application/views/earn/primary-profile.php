...
<div class="row">
<div class="top-btn">
<a class="active" href="#">Create professional Profile</a>
...
<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label input-box">
		...
		<label class="lsample" for="sample3">Primary Skills</label>
			<select id="skill" name="skill" data-attr="skill" class="input mb-10" style="width: 100%;margin-bottom: 10px !important;" placeholder="Primary skill">
...
$('#select-country').selectize();
			...
			<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label input-box small">
							<input data-attr="price" class="input mdl-textfield__input" type="text" name="price" id="price">
							<label class="mdl-textfield__label" for="sample3">Price</label>
						</div>
		<select name="price_per" data-attr="price_per" class="input form-control small">
    ...
    <label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="option-2">
      ...
      <span class="mdl-radio__label">Non-Negotiable</span>
				...
				<div style="display:none" class="asempss"><div class="as-emp">As Employee
				<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label input-box small">
			...
			<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label input-box">
			<input name="competitive" data-attr="competitive" class="input mdl-textfield__input" type="text" id="sample3">
  ...
  application/vnd.openxmlformats-officedocument.wordprocessingml.document" id="files" name="avatar[]" multiple>
			</div>
...
<script src="<?php echo base_url(); ?>assets/js/custom/primary-profile-form.js"></script>
