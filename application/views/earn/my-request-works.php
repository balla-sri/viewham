	<section class="ideazone">
		<div class="container">
			<div class="row mb-20">
				<div class="col-md-6">
					<h4 class="mt-0 mb-0">My Request Works</h4>
				</div>
				<div class="col-md-6 text-right">
					<a href="<?php echo base_url('earn/reuestforwork'); ?>" class="btn btn-info mb-0 mblock-btn">Request For Work</a>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
					<div class="ideazone-content form-box p-0">						
						...
						<?php 
						foreach($MyRequestWorks as $work){?>
						
						<div class="row h-line">
								<div class="col-md-6">
									<h6 class="mt-0">Skill</h6>
									<p>
						<?php  echo $work['skill_name']; ?>
								</p>
								...
								<a href="<?php echo base_url('earn/requestworkdetails/').$work['id']; ?>">see more</a>
								...
								<form id="coins-form_<?php echo $work['id']; ?>" action="<?php echo base_url('earn/SpendCoinds'); ?>" method="POST">	
								<div class="row">
									<div class="col-md-12 text-center">
										<p><input name="coins" data-id="<?php echo $work['id']; ?>" type="text" class="coins-spend form-control text-center" value="50" /> <span class="text-style1">Coins for "<b><span class="d-hrs">100</span></b>" Hours</span></p>
