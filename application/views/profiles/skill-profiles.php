	<section class="ideazone">
		<div class="container">
			<div class="row mb-20">
				<div class="col-md-6">
					<h4 class="mt-0 mb-0"><?php if(!empty($_GET)){
						echo '"&nbsp'.$_GET['key'].'&nbsp"';
					} ?> Profiles</h4>
				</div>
			...
			<div class="row">
				<div class="col-md-3">
					...
					<div class="filter-content grey-block mb-20">
						...
						<label>Profile Type</label>
							<select name="ptype" class="form-control">
								...
								<option value="3" <?php if(isset($_GET['ptype'])){ if($_GET['ptype']==3){ echo "selected"; } } ?>>Professional Profiles</option>
								<option value="4" <?php if(isset($_GET['ptype'])){ if($_GET['ptype']==4){ echo "selected"; } } ?>>Hobby Profiles</option>
								<option value="5" <?php if(isset($_GET['ptype'])){ if($_GET['ptype']==5){ echo "selected"; } } ?>>Other's Profiles</option>
							</select>
					...
					if($_GET['currency']=='ZAR'){ echo "selected";}} ?> value="ZAR">South African Rand </option>
							...
							<div class="row">
								<div class="col-xs-6">
									<input name="min_as_employee" type="text" class="form-control" value="<?php if(!empty($_GET['min_as_employee'])){ echo $_GET['min_as_employee']; }  ?>" placeholder="min" />
								</div>
								<div class="col-xs-6">
									<input name="max_as_employee" type="text" class="form-control" value="<?php if(!empty($_GET['max_as_employee'])){ echo $_GET['max_as_employee']; }  ?>" placeholder="max" />
								</div>
							</div>
							...
							<div class="row">
								<div class="col-xs-6">
									<input name="min_as_partner" type="text" class="form-control" value="<?php if(!empty($_GET['min_as_partner'])){ echo $_GET['min_as_partner']; }  ?>" placeholder="min" />
								</div>
								<div class="col-xs-6">
									<input name="max_as_partner" type="text" class="form-control" value="<?php if(!empty($_GET['max_as_partner'])){ echo $_GET['max_as_partner']; }  ?>" placeholder="max" />
								</div>
							</div>
						...
						<?php
							...
							<div class="col-sm-6 col-md-4">
								<div class="profile-box">
									<div class="p10 ">
									<div class="mb-10 pointer" <?php if(!empty($p['paid'])){ ?> onclick="window.location.href='<?php echo base_url('skill/candidateprofile/').$p['p_id']; ?>'" <?php }?> >
										<span >
								<?php  echo $p['name'];?>
										</span>
								<?php 
								...
								?>				
									...
									<div <?php if(!empty($p['paid'])){ ?> class="pointer"  onclick="window.location.href='<?php echo base_url('skill/details/').$p['p_id']; ?>'" <?php }?> >
