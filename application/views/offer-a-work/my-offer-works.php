				...
				<div class="col-md-12">
					<div class="ideazone-content form-box p-0">						
						...
						<?php  echo $work['skill_name']; ?>
								...
								<a href="<?php echo base_url('jobs/details/').$work['id']; ?>">see more</a>
								...
								<form id="coins-form_<?php echo $work['id']; ?>" action="<?php echo base_url('jobs/spendcoinds'); ?>" method="POST">	
								<div class="row">
									...
									<input id="postid" name="postid" type="hidden"  value="<?php echo $work['id']; ?>" />
									<input name="skill_id" type="hidden"  value="<?php echo $work['skill']; ?>" />										
									</div>
